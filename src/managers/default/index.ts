...
class DefaultViewManager implements Manager {
	public name: string;
	...
	createView(section: any, forceRight?: boolean): any {
		return new this.View(section, Object.assign({}, this.viewSettings, { forceRight }) );
	}
	...
	next(): Promise<void> | undefined {
		...
		if(this.isPaginated && this.settings.axis === "horizontal" && (!dir || dir === "ltr")) {
			...
			left = (this.container?.scrollLeft || 0) + (this.container?.offsetWidth || 0) + this.layout.delta;
			...
			let top  = (this.container?.scrollTop || 0) + (this.container?.offsetHeight || 0);
	...
	prev(): Promise<any> | undefined {
		...
		if(this.isPaginated && this.settings.axis === "horizontal" && (!dir || dir === "ltr")) {
			...
			if (this.settings.rtlScrollType === "default"){
				left = (this.container?.scrollLeft || 0) + (this.container?.offsetWidth || 0);
			...
			let top = this.container?.scrollTop || 0;
					...
					if(this.isPaginated && this.settings.axis === "horizontal") {
						if (this.settings.direction === "rtl") {
							if (this.settings.rtlScrollType === "default"){
								...
								this.scrollTo(((this.container?.scrollWidth || 0) * -1) + this.layout.delta, 0, true);
							}
						} else {
							this.scrollTo((this.container?.scrollWidth || 0) - this.layout.delta, 0, true);
						}
					}
					this.views?.show();
				});
	...
	isVisible(view: any, offsetPrev: any, offsetNext: any, _container: any): boolean {
