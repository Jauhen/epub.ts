...
class Annotations {
       ...
       remove(cfiRange: string, type: string): void {
	       ...
	       if (hash in this._annotations) {
		       ...
		       if (typeof annotation.sectionIndex === 'number') {
			       views.forEach((view: any) => {
				       this._removeFromAnnotationBySectionIndex(annotation.sectionIndex as number, hash);
				       const viewIndex = (view as any).index;
				       if (annotation.sectionIndex === viewIndex) {
	 ...
	 */
       private _removeFromAnnotationBySectionIndex(sectionIndex: number, hash: string): void {
	       this._annotationsBySectionIndex[sectionIndex] = this._annotationsAt(sectionIndex).filter((h: string) => h !== hash);
       }
...
class Annotation {
       ...
       // EventEmitter methods will be mixed in below
