...
export function replaceLinks(contents: any, fn: Function): void {
	...
	var replaceLink = function(link: Element){
		...
		var absolute = (href && href.indexOf("://") > -1);
...
export function substitute(content: any, urls: string[], replacements: string[]): any {
